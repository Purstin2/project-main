...
const SalesPage: React.FC = () => {
  ...
  const EXTERNAL_CHECKOUT_URL = "https://pagamento.fenjes.com/checkout/184693584:1";
            ...
            >
              ...
              <div className="flex justify-between gap-1 text-xs mb-2">
                <div className="bg-white/10 rounded-lg px-2 py-2 flex-1 flex items-center gap-1 text-center justify-center">
                  <span>Garantia</span>
                  <span className="text-yellow-300 font-bold truncate">7 DIAS</span>
                </div>
                <div className="bg-white/10 rounded-lg px-2 py-2 flex-1 flex items-center gap-1 text-center justify-center">
                  <span>Pagamento</span>
                  <span className="text-yellow-300 font-bold truncate">ÚNICO</span>
                </div>
                <div className="bg-white/10 rounded-lg px-2 py-2 flex-1 flex items-center gap-1 text-center justify-center">
                  <span>Acesso</span>
                  <span className="text-yellow-300 font-bold truncate">VITALÍCIO</span>
                </div>
              </div>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto px-5 relative">
            ...
            >
              <div className="flex items-center mx-8 whitespace-nowrap">
                ...
                <span className="text-sm text-gray-700">Método certificado</span>
              </div>
              <div className="flex items-center mx-8 whitespace-nowrap">
                ...
                <span className="text-sm text-gray-700">4.9/5 (873 avaliações)</span>
              </div>
              <div className="flex items-center mx-8 whitespace-nowrap">
                <Heart className="w-4 h-4 text-[#7432B4] mr-1.5" />
                <span className="text-sm text-gray-700">9.879 pessoas transformadas</span>
              </div>
              <div className="flex items-center mx-8 whitespace-nowrap">
                ...
                >
                  <span className="font-bold">{recentViewers}</span> pessoas online agora
                </motion.span>
              </div>
